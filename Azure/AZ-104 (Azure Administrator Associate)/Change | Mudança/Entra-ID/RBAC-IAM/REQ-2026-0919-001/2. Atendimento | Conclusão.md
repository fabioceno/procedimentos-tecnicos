...
4) Para incluir os usuários no grupo criado, foram realizados os procedimentos:
...
6) Editando o grupo que foi criado *gp_cenpc_entra-id_auth_external_invite*.
...
8) Alterando as permissões para envio de convites, limitando somente  
